...
model = load_model('bidirectional_lstm_pred_euroc_kernel_size_11.hdf5')
...
gyro_data, acc_data, pos_data, ori_data = load_euroc_mav_dataset('V2_02_medium/mav0/imu0/data.csv', 'V2_02_medium/mav0/state_groundtruth_estimate0/data.csv')
