...
#model_filename = 'bidirectional_lstm_mtl_pred_3D_mse_loss_conv_layers_batch_size_32_500_epochs_window_size_200_stride_10.hdf5'
model_filename = 'bidirectional_lstm_pred_euroc_kernel_size_11.hdf5'
...
for (cur_imu_data_filename, cur_gt_data_filename) in zip(imu_data_filenames, gt_data_filenames):
    ...
    #[yhat_delta_l, yhat_delta_theta, yhat_delta_psi] = model.predict([x_gyro[0:200, :, :], x_acc[0:200, :, :]], batch_size=1, verbose=0)
